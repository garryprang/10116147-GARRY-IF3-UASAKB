...
public class ListBandungB extends AppCompatActivity implements WisataAdapter.OnRsListener{
    private String TAG = ListBandungB.class.getSimpleName();
    ...
    public void onRsClick(int position) {
        ...
        Intent intent = new Intent(ListBandungB.this, wisata.class);
