...
public class wisata extends AppCompatActivity implements
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        if (response.body() == null) {
                            Log.e(SA, "Rute tidak ditemukan, tolong cek kembali tempat tujuan!");
                            return;
                        } else if (response.body().routes().size() == 0) {
                            Log.e(SA, "Rute tidak ditemukan!");
                            return;
                        }
    ...
    private class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<wisata> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(wisata activity) {
        ...
        public void onSuccess(LocationEngineResult result) {
            wisata activity = activityWeakReference.get();
